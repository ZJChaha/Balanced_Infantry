...
#define correct_Time_define 100    //上电去0飘 1000次取平均
#define temp_times 20       //探测温度阈值

pid_type_def Temperature_PID={0};
float Temperature_PID_Para[3]={2500,80,60};
    ...
    if ((count % 10) == 0)
    {
        ...
        IMU_Temperature_Ctrl();
			...
			//========================================================================================
				...
				if((fabsf(temp-RefTemp)<1.5f)&&attitude_flag==0) //接近额定温度之差小于0.5° 开始计数
				{
					temp_Ticks++;
